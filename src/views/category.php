...
<body>
                ...
                <section class="category-product-flex">
                    ...
                    <?php else : ?>
                        <div class="empty-category">
                            <img src=<?= aurl . "empty.jpg" ?> class="empty-img" alt="">
                            <div>მსგავსი კატეგორიის პროდუქტი ვერ მოიძებნა!</div>
                        </div>
                    <?php endif; ?>
                    <div class="products-hydration" style="display: none;"><?= $hydration ?></div>
                </section>
                <div class="pagination-container" id="paginationContainer" <?php echo Helper::visible($pages) ?>>
                    <div class="pagination-flex">
                        ...
                        <?php foreach ($pagesToShow as $page) : ?>
                            <a href="/vgparts/category?yearId=<?php echo $yearId; ?>&categoryId=<?php echo $categoryId; ?>&offset=<?php echo $page; ?>" class="number pad<?php echo Helper::isCurrentPage($page, $currentPage) ? ' active-pagination' : ''; ?>" data-page="<?php echo $page; ?>">
                                <?php echo $page; ?>
                            </a>
                        <?php endforeach; ?>
    ...
    <script src="/vgparts/public/js/category-parts.mjs" type="module"></script>
</body>