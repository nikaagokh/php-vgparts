...
<body>
                ...
                <div class="pagination-container" id="paginationContainer" <?php echo Helper::visible($pages) ?>>
                    <div class="pagination-flex">
                        ...
                        <?php foreach ($pagesToShow as $page) : ?>
                            <a href="/vgparts/groupby?path=<?php echo $path; ?>&group=<?php echo $group; ?>&offset=<?php echo $page; ?>" class="number pad<?php echo Helper::isCurrentPage($page, $currentPage) ? ' active-pagination' : ''; ?>" data-page="<?php echo $page; ?>">
                                <?php echo $page; ?>
                            </a>
                        <?php endforeach; ?>
    ...
    <script src="/vgparts/public/js/groupby.mjs" type="module"></script>
</body>