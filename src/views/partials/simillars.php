...
?>
<div class="simillars-container">
    <div class="app-slider__title">
        <h4 class="app-slider__category">მსგავსი პროდუქტები</h4>
    ...
    <div class="app-slider__body">
        <section class="app-slider__flex">
            <?php
                foreach ($simillars as $product): ?>
                    <article class="app-slider__card app-simillars__card" data-id="<?= $product['id']; ?>">
                    ...
                    <?php endforeach; ?>
            <div class="similars-hydration" style="display: none;"><?= Helper::encode($simillars) ?></div>
        </section>
    </div>
</div>